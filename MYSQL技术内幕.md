...
![image-20210126163910479](D:\学习笔记\image-20210126163910479.png)
...
![image-20210126182453383](D:\学习笔记\image-20210126182453383.png)
...
![image-20210128181914885](D:\学习笔记\image-20210128181914885.png)

在Linux下，存放mysql数据库的数据默认在/var/lib/mysql中，	

### SQL执行顺序

![image-20210128211020460](D:\学习笔记\image-20210128211020460.png)
...
![image-20210128211257462](D:\学习笔记\image-20210128211257462.png)

![image-20210128212558237](D:\学习笔记\image-20210128212558237.png)
...
![image-20210202173843597](D:\学习笔记\image-20210202173843597.png)
...
![image-20210203161348573](D:\学习笔记\image-20210203161348573.png)
...
![image-20210203162646027](D:\学习笔记\image-20210203162646027.png)
...
![image-20210203164433332](D:\学习笔记\image-20210203164433332.png)

![image-20210203172804721](D:\学习笔记\image-20210203172804721.png)
...
![image-20210203183844602](D:\学习笔记\image-20210203183844602.png)

show status like 'innodb_row_lock%';

![image-20210203184023659](D:\学习笔记\image-20210203184023659.png)
...
![image-20210203184737676](D:\学习笔记\image-20210203184737676.png)
...
![image-20210204120459918](D:\学习笔记\image-20210204120459918.png)
...
![image-20210204121845907](D:\学习笔记\image-20210204121845907.png)

### InnoDB体系结构

![image-20210204122011405](D:\学习笔记\image-20210204122011405.png)
...
![image-20210204123044005](D:\学习笔记\image-20210204123044005.png)

![image-20210204123129286](D:\学习笔记\image-20210204123129286.png)

主要功能：响应IO请求的回调，因为发出IO请求需要获得结果或者其他操作

![image-20210204123354012](D:\学习笔记\image-20210204123354012.png)
...
![image-20210204154818947](D:\学习笔记\image-20210204154818947.png)

具体来看，缓冲池缓冲的数据有：索引页，数据页，undo页，插入缓冲，自适应哈希索引，InnoDB存储的锁信息，数据字典信息。**不能简单认为缓冲池只缓冲索引页和数据页**，他们只是占缓冲池的很大一部分

索引页和数据页都以文件的形式存在于磁盘

![image-20210204155126316](D:\学习笔记\image-20210204155126316.png)

从1.0x开始允许有多个缓冲池实例。每个页根据哈希值平均分配到不同的缓冲池实例中

![image-20210204155337153](D:\学习笔记\image-20210204155337153.png)

![image-20210204155414792](D:\学习笔记\image-20210204155414792.png)
...
![image-20210204161058563](D:\学习笔记\image-20210204161058563.png)
...
![image-20210204163049877](D:\学习笔记\image-20210204163049877.png)
...
![image-20210204171358489](D:\学习笔记\image-20210204171358489.png)
...
![image-20210204171938305](D:\学习笔记\image-20210204171938305.png)

![image-20210204172136668](D:\学习笔记\image-20210204172136668.png)

并且从1.0x开始支持压缩页的功能，可以将原本16k的页压缩为1kb，2kb，4kb，8kb，由于页的大小发生变化，LRU列表也发生了一些变化，对于非16KB的页是通过unzip_LRU列表进行管理的

![image-20210204172329492](D:\学习笔记\image-20210204172329492.png)
...
![image-20210204174136517](D:\学习笔记\image-20210204174136517.png)
...
![image-20210205175526155](D:\学习笔记\image-20210205175526155.png)
...
![image-20210205180452891](D:\学习笔记\image-20210205180452891.png)
...
![image-20210205182325079](D:\学习笔记\image-20210205182325079.png)
...
![image-20210205182748189](D:\学习笔记\image-20210205182748189.png)

**Dirty Page too much CheckPoint**

顾名思义，脏页太多也会执行CheckPoint，这个多少是可以根据参数来进行设置Innodb_max_dirty_pages_pct控制

![image-20210205183635981](D:\学习笔记\image-20210205183635981.png)
...
![image-20210205195716025](D:\学习笔记\image-20210205195716025.png)
...
![image-20210205200518426](D:\学习笔记\image-20210205200518426.png)
...
![image-20210205201145349](D:\学习笔记\image-20210205201145349.png)
...
![image-20210205203243544](D:\学习笔记\image-20210205203243544.png)

还加入了一个自适应的刷新，通过重做日志的速度来决定最合适的刷新脏页数量

![image-20210205203516498](D:\学习笔记\image-20210205203516498.png)
...
![image-20210205205706520](D:\学习笔记\image-20210205205706520.png)

聚集索引，也叫聚簇索引

> 数据行的物理存储和列值的逻辑顺序相同，一个表中只能拥有一个聚集索引

![image-20210206114401294](D:\学习笔记\image-20210206114401294.png)
...
![image-20210206120405905](D:\学习笔记\image-20210206120405905.png)seg size代表了当前Insert Buffer的大小，free list代表了空闲列表的长度，size代表了已经合并的次数
...
![image-20210206141634532](D:\学习笔记\image-20210206141634532.png)

![image-20210206141647217](D:\学习笔记\image-20210206141647217.png)
...
![image-20210206143511430](D:\学习笔记\image-20210206143511430.png)
...
![image-20210206143742690](D:\学习笔记\image-20210206143742690.png)

![image-20210206144721221](D:\学习笔记\image-20210206144721221.png)
...
![image-20210206145205515](D:\学习笔记\image-20210206145205515.png)
...
![image-20210206152354906](D:\学习笔记\image-20210206152354906.png)
...
![image-20210206153821960](D:\学习笔记\image-20210206153821960.png)
...
![image-20210206154503259](D:\学习笔记\image-20210206154503259.png)
...
![image-20210206154656568](D:\学习笔记\image-20210206154656568.png)

但是如果重复变脏页呢？ 并且固态硬盘的磁盘读写快，建议关闭

#### 启动丶关闭和恢复

![image-20210206154827629](D:\学习笔记\image-20210206154827629.png)
...
![img](D:\学习笔记\@2O58R_1ZKJE70NW}U4%@_P.png)
