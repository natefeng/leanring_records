...
![image-20201109180631980](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201109180631980.png)
...
![image-20201117200849463](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201117200849463.png)
...
![image-20201126164226769](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201126164226769.png)
...
![image-20201201122955233](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201201122955233.png)
...
![image-20201202154221669](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201202154221669.png)
...
![image-20201202175111395](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201202175111395.png)

![image-20201202180443229](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201202180443229.png)
...
![image-20201202182237046](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201202182237046.png)

工作线程，线程池创建线程时，会将线程封装成工作线程Worker，Worker在执行的时候会不停的从工作队列里面获取任务来执行

![image-20201202182533336](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201202182533336.png)

![image-20201202182539278](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201202182539278.png)
...
![image-20201203101948642](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203101948642.png)
...
![image-20201203154005874](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203154005874.png)
...
![image-20201203171757258](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203171757258.png)
...
![image-20201203172402068](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203172402068.png)

虚线为实现 实线为继承

![image-20201203172424869](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203172424869.png)
...
![image-20201203172940882](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203172940882.png)
...
![image-20201203173629934](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203173629934.png)
...
![image-20201203173944666](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203173944666.png)
...
![image-20201203174358568](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203174358568.png)
...
![image-20201203174918350](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203174918350.png)

SynchronousQueue 不存储元素队列 每个插入必须等待线程取出

![image-20201203174940270](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203174940270.png)

## ScheduledThreadPoolExecutor

![image-20201203195038547](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203195038547.png)
...
![image-20201203195705747](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203195705747.png)

![image-20201203195941149](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203195941149.png)

![image-20201203195950968](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203195950968.png)

![image-20201203195955993](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203195955993.png)
...
![image-20201203200021115](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203200021115.png)

![image-20201203200025757](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201203200025757.png)
...
3）已完成    FutureTask执行完成后正常结束，调用FutureTask.cancel取消 和抛出异常而异常结束![image-20201204100806165](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204100806165.png)
...
![image-20201204101051747](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204101051747.png)

当一个线程需要等待另外一个线程把某个任务执行完成它才能继续执行 此时可以用FutureTask

多个线程试图执行同一任务时，只允许一个线程执行![image-20201204104038758](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204104038758.png)

![image-20201204104047833](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204104047833.png)

![image-20201204104842680](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204104842680.png)
...
![image-20201204112604948](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204112604948.png)
...
![image-20201204114405805](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204114405805.png)
...
![image-20201204141619608](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204141619608.png)

首先启动一个生产者把所有邮件加入阻塞队列 消费者启动corePoolSize个线程处理邮件

![image-20201204141734197](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204141734197.png)

![image-20201204141743511](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204141743511.png)

![image-20201204141750478](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204141750478.png)

![image-20201204141801529](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204141801529.png)

![image-20201204141806423](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204141806423.png)
...
![image-20201204151549559](https://sober-feng.oss-cn-shanghai.aliyuncs.com/learning/pictures/image-20201204151549559.png)
